...
PassportClient.prototype = {
   ...
   *
   * @param {string} changePasswordId The change password Id used to find the user. This value is generated by Passport once the change password workflow has been initiated.
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  exchangeRefreshTokenForAccessToken: function(request, callBack) {
      return this._start()
          .uri('/api/jwt/refresh')
          .setJSONBody(request)
          .post()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  issueAccessToken: function(applicationId, encodedJWT, callBack) {
      return this._start()
          .uri('/api/jwt/issue')
  ...
  /**
   * Send a two factor authentication code to a user. The user must have a mobile phone define and have 2FA enabled and Text Message set for delivery mode.
   *
   * @param {string} twoFactorId The two factor Id used to lookup the user. A user is provided a Two Factor Id during Login if a 2FA challenge is required.
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  pushTwoFactorCode: function(twoFactorId, callBack) {
      return this._start()
  ...
  retrieveOauthConfiguration: function(applicationId, callBack) {
      return this._start()
          .uri('/api/application/oauth-configuration')
          .urlSegment(applicationId)
          .get()
          .go(callBack);
  },
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  sendTwoFactorCodeToCompleteLogin: function(twoFactorId, callBack) {
      return this._start()
          .uri('/api/two-factor/send')
          .urlSegment(twoFactorId)
          .post()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  validateAccessToken: function(encodedJWT, callBack) {
      return this._start()
